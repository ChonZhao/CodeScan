...
public abstract class ResultParser {
     ...
     */
    protected abstract ParsedResult parse(Result theResult);
    ...
    private static String unescapeBackslash(String escaped) {
    ...
    static boolean isStringOfDigits(CharSequence value, int length) {
        return value != null && length > 0 && length == value.length() && DIGITS.matcher(value).matches();
    }

    static boolean isSubstringOfDigits(CharSequence value, int offset, int length) {
