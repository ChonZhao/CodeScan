...
public final class RSSExpandedReader extends AbstractRSSReader {
    ...
    private List<ExpandedPair> decodeRow2pairs(int rowNumber, BitArray row) throws NotFoundException {
        boolean done = false;
        while (!done) {
            try {
    ...
    private static Result constructResult(List<ExpandedPair> pairs) throws NotFoundException, FormatException {
    ...
    // not private for testing
    private ExpandedPair retrieveNextPair(BitArray row, List<ExpandedPair> previousPairs, int rowNumber)
