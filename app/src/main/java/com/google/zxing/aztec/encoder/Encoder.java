...
public final class Encoder {
    ...
    private static BitArray generateModeMessage(boolean compact, int layers, int messageSizeInWords) {
    ...
    private static BitArray stuffBits(BitArray bits, int wordSize) {
